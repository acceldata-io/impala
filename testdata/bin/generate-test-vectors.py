  ...
  with open(file_name, 'rb') as input_file:
    for line in input_file.readlines():
      ...
      if len(values) != 2:
        ...
        #      ' val2, ... Found: ' + line
        print("Invalid dimension file format. Expected format is <dimension name>: val1, val2, ... Found: "+line)
        sys.exit(1)
...
def write_vectors_to_csv(output_dir, output_file, matrix):
  ...
  #This needs to be verified as correct. "wb" could be a problem here
