...
export IMPALA_VERSION=4.5.0.3.4.3.0-SNAPSHOT
...
export ODP_BUILD_NUMBER=3.4.3.0-SNAPSHOT
export CDP_MAVEN_REPOSITORY=\
"https://${IMPALA_TOOLCHAIN_HOST}/build/cdp_components/${CDP_BUILD_NUMBER}/maven"
export CDP_AVRO_JAVA_VERSION=1.11.1
export CDP_HADOOP_VERSION=3.4.3.3.4.3.0-SNAPSHOT
export CDP_HBASE_VERSION=2.6.4.3.4.3.0-SNAPSHOT
...
export IMPALA_JACKSON_DATABIND_VERSION=2.18.1
