...
export IMPALA_VERSION=4.4.1.3.3.6.5-SNAPSHOT
...
export ODP_BUILD_NUMBER=3.3.6.5-SNAPSHOT
...
export CDP_RANGER_VERSION=2.5.0.3.3.6.5-SNAPSHOT
export CDP_TEZ_VERSION=0.10.4.3.3.6.5-SNAPSHOT
