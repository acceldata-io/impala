...
OS_MAPPING = [
  ...
  OsMapping("rhel10", "ec2-package-rocky-9"),
  OsMapping("rocky10", "ec2-package-rocky-9"),
  OsMapping("almalinux10", "ec2-package-rocky-9"),
...
class OdpComponent(EnvVersionedPackage):
  def __init__(self, name, explicit_version=None, archive_basename_tmpl=None,
    ...
    url_prefix_tmpl = "https://mirror-stg.odp.acceldata.dev/ODP/standalone/${odp_build_number}/"
