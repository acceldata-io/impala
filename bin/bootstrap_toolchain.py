...
class ToolchainKuduLocal(DownloadUnpackTarball):
  """
  ...
  def __init__(self, platform_label=None):
    ...
    super(ToolchainKuduLocal, self).__init__(
        url=None,
...
def get_kudu_downloads():
  ...
  use_local_kudu_tarball = os.environ.get("USE_LOCAL_KUDU_TARBALL", "false") == "true"
  
  if use_local_kudu_tarball:
    logging.info("Using a local tarball for kudu")
    return [ToolchainKuduLocal()]
  elif use_odp_kudu:
